...
const locationAssignmentSchema = z.discriminatedUnion("mode", [
  z.object({ mode: z.literal("single"), location: locationSchema }), //A discriminated union means:"I have multiple possible object shapes,
  //  and I can determine which shape to validate by looking at one specific property."Here, that property is "mode".
  z.object({
...
export const ResourceForm = ({
  ...
  const addMutation = useAddResource({
    onSuccess: (data) => {
      toast.success(data.message);
      reset();
